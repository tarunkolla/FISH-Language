...
class FishMain{
	...
	{
		FileInputStream fis = new FileInputStream("C:\\users\\koush\\Desktop\\firstFish.fish");
		...
		try
        {
        	PrintWriter writer = new PrintWriter("firstFish" + ".ic", "UTF-8");
